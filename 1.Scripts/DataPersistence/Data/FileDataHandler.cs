...
public class FileDataHandler
{
    ...
    public void Delete(string profildID)
    {
        if (profildID == null) return;

        string fullPath = Path.Combine(dataDirPath, profildID, dataFileName);
        ...
        try
        {
            ...
            {
                Debug.Log("Tried to delete profile data but data don't exist");
            }
        }
        catch (Exception e)
        {
    ...
    public Dictionary<string, GameData> LoadAllProfiles()
    {
        ...
        foreach (DirectoryInfo dirInfo in dirInfos)
        {
            ...
            if (!File.Exists(fullPath))
            {
                Debug.LogWarning("Skipping directory blabla");
                continue;
            }
